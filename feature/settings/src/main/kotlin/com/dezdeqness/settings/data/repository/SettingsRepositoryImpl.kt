package com.dezdeqness.settings.data.repository
...
class SettingsRepositoryImpl(
    ...
    override suspend fun <T> getPreference(key: SettingsPreference<T>): T {
        return context.dataStore.data.firstOrNull()?.let { key.handler.read(it, key) }
            ?: key.default
    }
